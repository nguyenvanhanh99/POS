    ...
    public partial class frmOrder : Form
    {
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Vui lòng truy xuất chi tiết khách hàng", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    Button1.Focus();
                    return;
                }
                ...
                if (txtTaxPer.Text == "")
                {
                    MessageBox.Show("Vui lòng nhập % thuế", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtTaxPer.Focus();
                    return;
                }
                 if (txtDiscountPer.Text == "")
                {
                    MessageBox.Show("Vui lòng nhập phần trăm chiết khấu", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtDiscountPer.Focus();
                    return;
                }
                if (txtTotalPayment.Text == "")
                {
                    MessageBox.Show("Vui lòng nhập tổng tiền thanh toán", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtTotalPayment.Focus();
                    return;
                }
                 if (cmbPaymentType.Text == "")
                {
                    MessageBox.Show("Vui lòng chọn hình thức thanh toán", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    cmbPaymentType.Focus();
                    return;
                }
                 if (cmbStatus.Text == "")
                {
                    MessageBox.Show("Vui lòng chọn trạng thái", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    cmbStatus.Focus();
                    return;
                }
                if (ListView1.Items.Count == 0)
                {
                    MessageBox.Show("Không có sản phẩm để thêm vào", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                GetData();
                MessageBox.Show("Đặt hàng thành công", "Order", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
      ...
      public void Calculate()
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtCustomerID.Text == "")
                {
                    MessageBox.Show("Please retrieve Customer ID", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtCustomerID.Focus();
                    return;
                }
                ...
                {
                    MessageBox.Show("Please retrieve product name", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                if (txtSaleQty.Text=="")
                {
                    MessageBox.Show("Please enter no. of sale quantity", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSaleQty.Focus();
                    return;
                }
                ...
                if (SaleQty == 0)
                {
                    MessageBox.Show("no. of sale quantity can not be zero", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSaleQty.Focus();
                    return;
                }
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                if (ListView1.Items.Count == 0)
                {
                    MessageBox.Show("No items to remove", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    int itmCnt = 0;
        ...
        private void txtTotalPayment_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (val2 > val1)
            {
                MessageBox.Show("Total Payment can't be more than grand total", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTotalPayment.Text = "";
                txtPaymentDue.Text = "";
                txtTotalPayment.Focus();
                return;
        ...
        private void txtSaleQty_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (val2 > val1)
            {
                MessageBox.Show("Selling quantities are more than available quantities", "Thao tác lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtSaleQty.Text = "";
                txtTotalAmount.Text = "";
                txtSaleQty.Focus();
                return;
