...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
        ...
        private void Reset()
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter sub Category", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtSubCategory.Focus();
                return;
            }
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("SubCategory Name Already Exists", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSubCategory.Text = "";
                    txtSubCategory.Focus();
