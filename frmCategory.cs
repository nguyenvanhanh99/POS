...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
    public partial class frmCategory : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter Category name", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("Category Name Already Exists", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
